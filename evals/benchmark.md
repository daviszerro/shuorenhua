...
| status | SF-02, SF-09, SF-15, SF-21, SF-25, SF-30, SNF-03, SNF-06, SNF-10, SNF-13, SNF-19, SNF-21, SNF-28 | - | - | SF-23, SNF-18 |
...
| public-writing | SF-03, SF-05, SF-08, SF-10, SF-12, SF-13, SF-16, SF-20, SF-28, SF-32, SF-33, SF-35, SNF-12, SNF-24, SNF-25, SNF-27 | SF-34, SF-39, SF-40, SF-41, SNF-26, SNF-29, SNF-30, SNF-31 | SF-14 | - |
| code-context | - | - | - | SNF-22 |

`Long-form / in-place` 额外覆盖：SF-39、SF-40、SNF-29、SNF-30。它们验证的不是“更轻一档”，而是 `scope = in-place` 时不删整句、不并句、不重排段落。`Bounded`（v1.8.6）额外覆盖：SF-41、SNF-31，验证 `scope = bounded` 时整句空话进删除清单、实句和节奏句不进清单。
...
- `Bounded` 样本额外要求：句内洗实句、保留承担节奏的重复；整句空话（空总结 / 价值拔高 / 无源引用 / 整句旁白）应进「建议删除（待确认）」清单，而不是直接删或软化成新说法；删除清单里混进实句、带信息句或节奏句，记 `❌`；字数留存不设硬下限（删整句空话会降字数），但原文每个信息点必须可追溯
